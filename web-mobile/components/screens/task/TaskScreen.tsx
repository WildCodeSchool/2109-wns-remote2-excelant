                    ...
                    renderItem={(task) => (
                        <>
                            <View style={row}>
                                ...
                                <Text style={field}>{task.item.name}</Text>
                            </View>
                            <View style={{...row, backgroundColor: "lightgrey"}}>
                                <Text style={label}>Project</Text>
                                <Text style={field}>{task.item.project}</Text>
                            </View>
                            <View style={row}>
                                <Text style={label}>Assignee</Text>
                                <Text style={field}>{task.item.assigne}</Text>
                            </View>
                            <View style={{...row, backgroundColor: "lightgrey"}}>
                                <Text style={label}>Status</Text>
                                <Text style={field}>{task.item.status}</Text>
                            </View>
                            <View style={row}>
                                <Text style={label}>Due Date</Text>
                                <Text style={field}>{task.item.dueDate}</Text>
                            </View>
                            {task.index !== data.findAllTasks.length - 1 && (
                                <Text style={{...row, backgroundColor: "lightgrey"}}>
                                    ~
                                </Text>
                            )}
                        </>
